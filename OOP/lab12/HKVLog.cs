...
namespace Lab12
{
    ...
    public static class HKVLog
    {
        private static StreamWriter logfile;
        private static string pathLog = @"C:\BSTU\SEM3\OOP\lab12oop\lab12oop\HKVLogfile.txt";
        ...
        public static void FindInfo()
        {
            ...
            using (var stream = new StreamWriter(@"C:\BSTU\SEM3\OOP\lab12oop\lab12oop\LogV2.txt"))
            {
