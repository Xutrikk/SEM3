    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                newD.Load(@"C:\BSTU\SEM3\OOP\lab13oop\lab13oop\obj\Debug\netcoreapp3.1\lab13oop.dll");
            ...
            using (StreamWriter sw = new StreamWriter(@"C:\BSTU\SEM3\OOP\lab14oop\lab14oop\task2.txt", false))
            {
                for (var i = 1; i <= n; i++)
                {
                    var isSimple = true;
