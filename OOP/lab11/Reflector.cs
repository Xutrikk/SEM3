...
namespace Lab11
{
    ...
    public static class Reflector
    {
        ...
        {
            sw = new StreamWriter(@"C:\BSTU\SEM3\OOP\lab11oop\lab11oop\ClassInfo.txt", true);
        ...
        public static void Invoke(string className, string methodName)
        {
            try
            {
                ...
                List<string> list = File.ReadAllLines(@"C:\BSTU\SEM3\OOP\lab11oop\lab11oop\invoke.txt").ToList();
        ...
        {
            using (sw = new StreamWriter(@"C:\BSTU\SEM3\OOP\lab11oop\lab11oop\ClassInfo.txt", false))
            {
                sw.WriteLine("");
            }
            sw.Close();
